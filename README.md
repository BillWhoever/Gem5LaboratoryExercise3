...
|- Machine #1 -       |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 479.262916  | D = 0.153747 | A = 32.2026 | EDAP = 2372.8561662 |um*J*s|
|Bench: 429mcf        | E = 353.673161  | D = 0.113881 | A = 32.2026 | EDAP = 1297.01295388|um*J*s|
|Bench: 456hmmer      | E = 374.025984  | D = 0.118264 | A = 32.2026 | EDAP = 1424.44365679|um*J*s|
|Bench: 458sjeng      | E = 2029.421792 | D = 0.705755 | A = 32.2026 | EDAP = 46122.9652873|um*J*s|
|Bench: 470lbm        | E = 772.186533  | D = 0.262833 | A = 32.2026 | EDAP = 6535.71420337|um*J*s|

|- Machine #2 -       |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 448.583068  | D = 0.159489 | A = 30.545  | EDAP = 2185.31346336|um*J*s|
|Bench: 429mcf        | E = 319.200019  | D = 0.113756 | A = 30.545  | EDAP = 1109.1169708 |um*J*s|
|Bench: 456hmmer      | E = 340.093648  | D = 0.11899  | A = 30.545  | EDAP = 1236.0872153 |um*J*s|
|Bench: 458sjeng      | E = 1847.874082 | D = 0.705755 | A = 30.545  | EDAP = 39835.1509554|um*J*s|
|Bench: 470lbm        | E = 702.117716  | D = 0.263117 | A = 30.545  | EDAP = 5642.85602578|um*J*s|

|- Machine #3 -       |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 443.974563  | D = 0.153748 | A = 30.6957 | EDAP = 2095.29465528|um*J*s|
|Bench: 429mcf        | E = 325.841879  | D = 0.113559 | A = 30.6957 | EDAP = 1135.81082288|um*J*s|
|Bench: 456hmmer      | E = 346.879665  | D = 0.118264 | A = 30.6957 | EDAP = 1259.24126422|um*J*s|
|Bench: 458sjeng      | E = 1867.427376 | D = 0.705757 | A = 30.6957 | EDAP = 40455.3960532|um*J*s|
|Bench: 470lbm        | E = 714.836635  | D = 0.262833 | A = 30.6957 | EDAP = 5767.18968328|um*J*s|

|- Machine #4 -       |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 484.395309  | D = 0.156092 | A = 26.7986 | EDAP = 2026.24837862|um*J*s|
|Bench: 429mcf        | E = 351.834552  | D = 0.113766 | A = 26.7986 | EDAP = 1072.66246089|um*J*s|
|Bench: 456hmmer      | E = 373.450192  | D = 0.118263 | A = 26.7986 | EDAP = 1183.56928204|um*J*s|
|Bench: 458sjeng      | E = 2023.243595 | D = 0.705935 | A = 26.7986 | EDAP = 38275.8633321|um*J*s|
|Bench: 470lbm        | E = 771.599882  | D = 0.263078 | A = 26.7986 | EDAP = 5439.87337335|um*J*s|

|- Machine #5 -       |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 488.872194  | D = 0.157986 | A = 23.4957 | EDAP = 1814.68950703|um*J*s|
|Bench: 429mcf        | E = 352.090438  | D = 0.11394  | A = 23.4957 | EDAP = 942.581331991|um*J*s|
|Bench: 456hmmer      | E = 373.205506  | D = 0.118263 | A = 23.4957 | EDAP = 1037.01567824|um*J*s|
|Bench: 458sjeng      | E = 2019.207734 | D = 0.706012 | A = 23.4957 | EDAP = 33495.1149163|um*J*s|
|Bench: 470lbm        | E = 771.564619  | D = 0.263263 | A = 23.4957 | EDAP = 4772.55034787|um*J*s|

|- Machine #6 -       |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 565.397385  | D = 0.152645 | A = 38.4487 | EDAP = 3318.31827678|um*J*s|
|Bench: 429mcf        | E = 417.055032  | D = 0.113393 | A = 38.4487 | EDAP = 1818.28213336|um*J*s|
|Bench: 456hmmer      | E = 444.17898   | D = 0.118217 | A = 38.4487 | EDAP = 2018.92226175|um*J*s|
|Bench: 458sjeng      | E = 2391.223349 | D = 0.703833 | A = 38.4487 | EDAP = 64710.0042571|um*J*s|
|Bench: 470lbm        | E = 912.449275  | D = 0.262713 | A = 38.4487 | EDAP = 9216.62578546|um*J*s|

|- Machine #7 -       |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 330.17921   | D = 0.16382  | A = 30.9957 | EDAP = 1676.55611683|um*J*s|
|Bench: 429mcf        | E = 234.703784  | D = 0.115267 | A = 30.9957 | EDAP = 838.545302696|um*J*s|
|Bench: 456hmmer      | E = 244.071482  | D = 0.118598 | A = 30.9957 | EDAP = 897.213608814|um*J*s|
|Bench: 458sjeng      | E = 2186.346204 | D = 0.166498 | A = 30.9957 | EDAP = 11283.1250827|um*J*s|
|Bench: 470lbm        | E = 747.404782  | D = 0.391979 | A = 30.9957 | EDAP = 9080.71659234|um*J*s|

|- Machine #8 -       |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 1004.26259  | D = 0.153312 | A = 56.0591 | EDAP = 8631.16770851|um*J*s|
|Bench: 429mcf        | E = 720.447672  | D = 0.111498 | A = 56.0591 | EDAP = 4503.14198667|um*J*s|
|Bench: 456hmmer      | E = 783.488522  | D = 0.117818 | A = 56.0591 | EDAP = 5174.76230326|um*J*s|
|Bench: 458sjeng      | E = 3025.861934 | D = 0.501106 | A = 56.0591 | EDAP = 85001.1559411|um*J*s|
|Bench: 470lbm        | E = 1244.418099 | D = 0.199148 | A = 56.0591 | EDAP = 13892.755394 |um*J*s|

|- Machine #9 -       |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 479.634865  | D = 0.153478 | A = 32.2516 | EDAP = 2374.14992533|um*J*s|
|Bench: 429mcf        | E = 352.788681  | D = 0.113403 | A = 32.2516 | EDAP = 1290.2992687 |um*J*s|
|Bench: 456hmmer      | E = 375.15493   | D = 0.118144 | A = 32.2516 | EDAP = 1429.4652213 |um*J*s|
|Bench: 458sjeng      | E = 2022.206927 | D = 0.70384  | A = 32.2516 | EDAP = 45904.0287791|um*J*s|
|Bench: 470lbm        | E = 773.38051   | D = 0.262076 | A = 32.2516 | EDAP = 6536.89847003|um*J*s|

|- Machine #10 -      |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 432.092289  | D = 0.153305 | A = 39.7609 | EDAP = 2633.83789432|um*J*s|
|Bench: 429mcf        | E = 317.346593  | D = 0.113388 | A = 39.7609 | EDAP = 1430.72821353|um*J*s|
|Bench: 456hmmer      | E = 339.501954  | D = 0.118136 | A = 39.7609 | EDAP = 1594.70643349|um*J*s|
|Bench: 458sjeng      | E = 1781.298606 | D = 0.703865 | A = 39.7609 | EDAP = 49851.9676485|um*J*s|
|Bench: 470lbm        | E = 686.255441  | D = 0.262076 | A = 39.7609 | EDAP = 7151.04084476|um*J*s|

|- Machine #11 -      |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 505.824863  | D = 0.153331 | A = 48.6607 | EDAP = 3774.0573275 |um*J*s|
|Bench: 429mcf        | E = 370.237786  | D = 0.113388 | A = 48.6607 | EDAP = 2042.80159073|um*J*s|
|Bench: 456hmmer      | E = 397.664856  | D = 0.118135 | A = 48.6607 | EDAP = 2285.98906827|um*J*s|
|Bench: 458sjeng      | E = 2065.876826 | D = 0.703906 | A = 48.6607 | EDAP = 70761.5672376|um*J*s|
|Bench: 470lbm        | E = 798.598511  | D = 0.262076 | A = 48.6607 | EDAP = 10184.3683794|um*J*s|

|- Machine #12 -      |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 759.740423  | D = 0.152692 | A = 67.8338 | EDAP = 7869.14711296|um*J*s|
|Bench: 429mcf        | E = 543.732892  | D = 0.11129  | A = 67.8338 | EDAP = 4104.76118147|um*J*s|
|Bench: 456hmmer      | E = 599.778357  | D = 0.11771  | A = 67.8338 | EDAP = 4789.06020226|um*J*s|
|Bench: 458sjeng      | E = 2186.578465 | D = 0.497248 | A = 67.8338 | EDAP = 73753.7756944|um*J*s|
|Bench: 470lbm        | E = 925.175516  | D = 0.198912 | A = 67.8338 | EDAP = 12483.3532935|um*J*s|

|- Machine #13 -      |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 803.77041   | D = 0.151798 | A = 122.617 | EDAP = 14960.5909921|um*J*s|
|Bench: 429mcf        | E = 578.313878  | D = 0.109894 | A = 122.617 | EDAP = 7792.70582771|um*J*s|
|Bench: 456hmmer      | E = 627.521133  | D = 0.117547 | A = 122.617 | EDAP = 9044.62555856|um*J*s|
|Bench: 458sjeng      | E = 1937.30813  | D = 0.371467 | A = 122.617 | EDAP = 88240.8383796|um*J*s|
|Bench: 470lbm        | E = 843.710064  | D = 0.165386 | A = 122.617 | EDAP = 17109.7104254|um*J*s|

|- Machine #14 -      |                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 813.28481   | D = 0.160384 | A = 80.3662 | EDAP = 10482.7960257|um*J*s|
|Bench: 429mcf        | E = 538.886712  | D = 0.110248 | A = 80.3662 | EDAP = 4774.6509529 |um*J*s|
|Bench: 456hmmer      | E = 604.46287   | D = 0.117723 | A = 80.3662 | EDAP = 5718.79308821|um*J*s|
|Bench: 458sjeng      | E = 1735.677251 | D = 0.371585 | A = 80.3662 | EDAP = 51832.3117924|um*J*s|
|Bench: 470lbm        | E = 802.837473  | D = 0.165512 | A = 80.3662 | EDAP = 10678.9992427|um*J*s|

|- Machine #idealNew -|                 |              |             |                     |      |
|---------------------|-----------------|--------------|-------------|---------------------|------|
|Bench: 401bzip2      | E = 254.217529  | D = 0.171643 | A = 14.4371 | EDAP = 629.957940215|um*J*s|
|Bench: 429mcf        | E = 173.836834  | D = 0.115111 | A = 14.4371 | EDAP = 288.894048629|um*J*s|
|Bench: 456hmmer      | E = 181.024929  | D = 0.118795 | A = 14.4371 | EDAP = 310.467762918|um*J*s|
|Bench: 458sjeng      | E = 1615.123752 | D = 0.165906 | A = 14.4371 | EDAP = 3868.54685383|um*J*s|
|Bench: 470lbm        | E = 554.728596  | D = 0.392222 | A = 14.4371 | EDAP = 3141.17743285|um*J*s|
